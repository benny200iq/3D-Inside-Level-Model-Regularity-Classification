...
if len(np.unique(y_test)) > 1 and len(np.unique(y_train)) > 1:
    ...
    print("SVM AUC-ROC: Not applicable (only one class in y_test or y_train)")
...
# Repeat similar checks for Random Forest and XGBoost
...
if len(np.unique(y_test)) > 1 and len(np.unique(y_train)) > 1:
    ...
    print("Random Forest AUC-ROC: Not applicable (only one class in y_test or y_train)")
...
if len(np.unique(y_test)) > 1 and len(np.unique(y_train)) > 1:
    ...
    print("XGBoost AUC-ROC: Not applicable (only one class in y_test or y_train)")
