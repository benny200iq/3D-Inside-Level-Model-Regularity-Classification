...
excel_path = 'Dataset\pix3d\label\pix3d.xlsx'
...
def save_validated_data(validated_labels_df, output_file_path='Dataset\pix3d\label\Final_Validated_Regularity_Levels.xlsx'):
    """
...
if __name__ == "__main__":
    base_dir = 'Dataset\pix3d\obj-pix3d'
    ...
    save_validated_data(validated_labels_df, 'Dataset\pix3d\label\Final_Validated_Regularity_Levels.xlsx')